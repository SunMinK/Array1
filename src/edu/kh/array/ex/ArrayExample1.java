...
public class ArrayExample1 {
	...
	public void ex1() {
		...
		//num에 작성된 자리에 num에 저장된 값을 읽어와서 출력
	...
	public void ex4() {
		// 입력 받은 인원 수 만큼의 점수를 입려 받아 배열에 저장
	...
	public void ex5() {
		// 배열 선언과 동시에 초기화
		  ...
		  int[] arr2 = new int[4];
		  // Arrays.toSrting(배열명) : 모든 요소 값 출력
		 ...
		 // heap영역에 char 5칸짜리 char[]을 생성하고		 
		   // 각 'A','B','C','D','E' 로 초기화 후 주소를 arr3에 대입
	...
	public void ex9() {
		...
		char[] arr = new char[input.length()]; // 문자열을 입력할 수 있는 input과 길이를 알수잇는 식(
											   // 아직 값 대입 안했음.공간만 생성
	...
	public void ex13() {
		...
		Scanner sc = new Scanner(System.in);
		System.out.print("문자를 입력하세요 :");  // 자료형만 맞으면 체이닝 해서 계속 쓸수 있음
		String input = sc.nextLine(); 		  // 예) sc.nextLine.next.nextChar()
		
		char[] arr = new char[input.length()]; //char 길이
